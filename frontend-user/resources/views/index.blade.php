                  ...
                  <div class=" col-md-2 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                              <a href="index.html"><img src="Asset/images/logoo.png" alt="#" height="50" width="50"/></a>
                           </div>
                        </div>
                     </div>
                  </div>
                                            ...
                                            <div class="container">
                                                <div class="carousel-caption posi_in">
                                                    <div class="clientsl_text">
                                                        <i><img src="Asset/images/clint.jpg" alt="#"/></i>
                                                        <h3>Deno <img src="Asset/images/icon.png" alt="#"/></h3>
                  ...
                  <div class="row d_flex">
                     ...
                     <div class="col-md-6">
                        <ul class="social_icon text_align_center">
                           <li> <a href="https://www.facebook.com/teknokrat" target="_blank"><i class="fa fa-facebook-f"></i></a></li>
                           <li> <a href="https://twitter.com/teknokrat_id" target="_blank"><i class="fa fa-twitter"></i></a></li>
                           <li> <a href="https://www.instagram.com/teknokrat_university/" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                           <li> <a href="https://www.youtube.com/channel/UCYVRIU8V_Td9fHJRA2u57cg" target="_blank"><i class="fa fa-youtube-play" aria-hidden="true"></i></a></li>
                        </ul>
                     </div>
                  </div>
               </div>
